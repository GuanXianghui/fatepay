...
<html>
<head>
    <title>测试[支付结果后台返回接口]页面</title>
</head>
<body>
<div align="center">
    <h2>测试[支付结果后台返回接口]页面</h2>
    <form action="payReturnBg.do" method="post">
        ...
        通知类型：<input type="text" name="notify_type" value="offline_notify"><br>
        ...
        交易状态：<input type="text" name="trade_status" value="FAIL"><br>
        ...
        签名：<input type="text" name="sign" value="fb17763772c6c18bddf84b072f8d5c62"><br>
